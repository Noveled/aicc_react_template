...
import { adDetails } from '../../constants/data';
  ...
  return (
      ...
      {moreInfo ? (
          <div className='mt-12'>
              <div className='flex-col flex-wrap items-center'>
                  <div className='p-2 w-full text-center'>
                      <div className='text-4xl font-customFontKr mb-8'>분석을 위한 대시보드</div>
                      <p className='text-base font-customFontEn'>Gain valuable insights into user interactions and behavior within your VR applications with an integrated analytics dashboard.</p>
                  </div>
                  {
                      adDetails.map((content, idx) => (
          ...
          <div className='flex flex-wrap items-center'>
              <div className='p-2 w-full text-center'>
                  <div className='text-4xl mb-8 font-customFontKr'>분석을 위한 대시보드</div>
                  <p className='text-base font-customFontEn'>Gain valuable insights into user interactions and behavior within your VR applications with an integrated analytics dashboard.</p>
              </div>
          </div>
          <div className='py-4'>

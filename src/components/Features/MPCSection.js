...
import { mpcDetails } from '../../constants/data';
  ...
  return (
      ...
      {moreInfo ? (
          <div className='mt-12'>
              <div className='flex-col flex-wrap items-center'>
                  <div className='p-2 w-full text-center'>
                      <div className='text-4xl font-customFontKr mb-8'>멀티 플랫폼 확장성</div>
                      <p className='text-base font-customFontEn'>Build VR applications that run seamlessly across multiple platforms, including mobile, desktop, and VR headsets.</p>
                  </div>
                  {
                      mpcDetails.map((content, idx) => (
          ...
          <div className='flex flex-wrap items-center'>
              <div className='p-2 w-full text-center'>
                  <div className='text-4xl mb-8 font-customFontKr'>멀티 플랫폼 확장성</div>
                  <p className='text-base font-customFontEn'>Build VR applications that run seamlessly across multiple platforms, including mobile, desktop, and VR headsets.</p>
              </div>
          </div>
          <div className='py-4'>

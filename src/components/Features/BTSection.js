...
import { btDetails } from '../../constants/data';
  ...
  return (
      ...
      {moreInfo ? (
          <div className='mt-12'>
              <div className='flex-col flex-wrap items-center'>
                  <div className='p-2 w-full text-center'>
                      <div className='text-4xl font-customFontKr mb-8'>깔맞춤 탬플릿</div>
                      <p className='text-base font-customFontEn'>Jumpstart your VR projects with a variety of built-in templates for different types of applications and environments.</p>
                  </div>
                  {
                      btDetails.map((content, idx) => (
          ...
          <div className='flex flex-wrap items-center'>
              <div className='p-2 w-full text-center'>
                  <div className='text-4xl mb-8 font-customFontKr'>깔맞춤 탬플릿</div>
                  <p className='text-base font-customFontEn'>Jumpstart your VR projects with a variety of built-in templates for different types of applications and environments.</p>
              </div>
          </div>
          <div className='py-4'>

...
import { rtpDetails } from '../../constants/data';
  ...
  return (
      ...
      {moreInfo ? (
          <div className='mt-12'>
              <div className='flex-col flex-wrap items-center'>
                  <div className='p-2 w-full text-center'>
                      <div className='text-4xl font-customFontKr mb-8'>실시간 리뷰</div>
                      <p className='text-base font-customFontEn'>Preview your VR application in real-time as you make changes, allowing for quick iterations and adjustments.</p>
                  </div>
                  {
                      rtpDetails.map((content, idx) => (
          ...
          <div className='flex flex-wrap items-center'>
              <div className='p-2 w-full text-center'>
                  <div className='text-4xl mb-8 font-customFontKr'>실시간 리뷰</div>
                  <p className='text-base font-customFontEn'>Preview your VR application in real-time as you make changes, allowing for quick iterations and adjustments.</p>
              </div>
          </div>
          <div className='py-4'>

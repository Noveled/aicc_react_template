...
import { ddiDetails } from '../../constants/data';
    ...
    return (
        ...
        {moreInfo ? (
            <div className='mt-12'>
                <div className='flex-col flex-wrap items-center'>
                    <div className='p-2 w-full text-center'>
                        <div className='text-4xl font-customFontKr mb-8'>편리한 사용자 인터페이스</div>
                        <p className='text-base font-customFontEn'>Easily design and arrange your VR environments with a user-friendly drag-and-drop interface.</p>
                    </div>
                    {
                        ddiDetails.map((content, idx) => (
                        <div key={idx} className={idx !== 0 && 'pt-1'}>
                            <h2 className='my-5 text-2xl text-indigo-400 font-semibold'>{content.title}</h2>
                            <div className='flex flex-col items-center w-4/5 mx-auto hover:w-full'>
            ...
            <div className='flex flex-wrap items-center'>
                <div className='p-2 w-full text-center'>
                    <div className='text-4xl mb-8 font-customFontKr'>편리한 사용자 인터페이스</div>
                    <p className='text-base font-customFontEn'>Easily design and arrange your VR environments with a user-friendly drag-and-drop interface.</p>
                </div>
            </div>
            <div className='py-4'>
